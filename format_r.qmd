...
Ce n'est plus le cas pour le même vecteur répété 6 fois. Les calculs effectués par la librairie arrow ont une exigence moindre de reproductibilité et de conformité aux standards. Dans le cas des statistiques, toutefois, en genéral, l'extrême précision sous la virgule importe peu.
...
Comme on le voit ci-dessus, si on effectue le calcul dans C avec une simple boucle, on retrouve les résultats donnés par R. Mais la réassociation permet d'obtenir une efficience bien plus grande, en effectuant des calculs pyramidaux.
