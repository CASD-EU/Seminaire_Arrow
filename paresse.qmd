...
Il semble ici qu'en filtrant ou non, on obtient des performances similaires. Nous pouvons par ailleurs avoir une estimation via C du débit de lecture.
...
Lire l'intégralité des fichiers parquet dans C dure `r `temps_total` secondes. Cela semble prouver que l'exécution des `ExecPlan` est naturellement parcimonieuse.
