...
En construisant un nouveau vecteur character dans C à partir de la valeur pointée par `{r} capture.output(print(adresse))`, on peut vérifier que l'adresse pointe bien vers une chaine de caractères C qui contient `{r} get_string(adresse)`. Nous avons illustré la présence de la *global string pool*.
